$(document).ready(function () {
    if($('.datatable-1').length>0){
        ...
        $('.dataTables_paginate > a:first-child').append('<i class="fas fa-chevron-left shaded"></i>');
        $('.dataTables_paginate > a:last-child').append('<i class="fas fa-chevron-right shaded"></i>');
